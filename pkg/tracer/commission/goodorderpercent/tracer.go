...
func trace(span trace1.Span, in *npool.OrderPercentReq, index int) trace1.Span {
	span.SetAttributes(
...
func Trace(span trace1.Span, in *npool.OrderPercentReq) trace1.Span {
...
func TraceMany(span trace1.Span, infos []*npool.OrderPercentReq) trace1.Span {
