...
func trace(span trace1.Span, in *npool.AllocatedReq, index int) trace1.Span {
	span.SetAttributes(
...
func Trace(span trace1.Span, in *npool.AllocatedReq) trace1.Span {
...
func TraceMany(span trace1.Span, infos []*npool.AllocatedReq) trace1.Span {
