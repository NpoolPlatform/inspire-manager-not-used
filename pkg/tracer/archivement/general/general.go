...
func trace(span trace1.Span, in *npool.GeneralReq, index int) trace1.Span {
	span.SetAttributes(
		...
		attribute.String(fmt.Sprintf("TotalUnits.%v", index), in.GetTotalUnits()),
		attribute.String(fmt.Sprintf("SelfUnits.%v", index), in.GetSelfUnits()),
...
func TraceConds(span trace1.Span, in *npool.Conds) trace1.Span {
	span.SetAttributes(
		...
		attribute.String("TotalUnits.Value", in.GetTotalUnits().GetValue()),
		attribute.String("SelfUnits.Op", in.GetSelfUnits().GetOp()),
		attribute.String("SelfUnits.Value", in.GetSelfUnits().GetValue()),
